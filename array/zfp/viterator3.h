// forward iterator that visits 3D array block by block; this class is nested within zfp::varray3
class iterator {
public:
  // typedefs for STL compatibility
  typedef Scalar value_type;
  typedef ptrdiff_t difference_type;
  typedef typename varray3::reference reference;
  typedef typename varray3::pointer pointer;
...
protected:
  ...
  explicit iterator(varray3* array, uint i, uint j, uint k) : ref(array, i, j, k) {}
  void increment()
  {
    ref.i++;
