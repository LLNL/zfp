// forward iterator that visits 2D array block by block; this class is nested within zfp::varray2
class iterator {
public:
  // typedefs for STL compatibility
  typedef Scalar value_type;
  typedef ptrdiff_t difference_type;
  typedef typename varray2::reference reference;
  typedef typename varray2::pointer pointer;
...
protected:
  ...
  explicit iterator(varray2* array, uint i, uint j) : ref(array, i, j) {}
  void increment()
  {
    ref.i++;
