...
public:
  ...
  // constructor
  explicit const_iterator(container_type* container, uint i, uint j) : const_handle(container, i, j) {}
...
public:
  ...
  // constructor
  explicit iterator(container_type* container, uint i, uint j) : const_iterator(container, i, j) {}
