//#warning "should template this on surrounding array class"
// reference to a 2D varray element; this class is nested within zfp::varray2
class reference {
public:
...
protected:
  ...
  explicit reference(varray2* array, uint i, uint j) : array(array), i(i), j(j) {}
  varray2* array;
  uint i, j;
};
