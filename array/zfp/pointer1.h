...
public:
  ...
  // constructor
  explicit const_pointer(const container_type* container, size_t i) : const_handle(container, i) {}
...
public:
  ...
  // constructor
  explicit pointer(container_type* container, size_t i) : const_pointer(container, i) {}
