...
public:
  Codec3d(BitStream& bitstream, uint nmin = 0, uint nmax = 0, uint pmax = 0, int emin = INT_MIN) : Codec3<BitStream, double, FixedPoint::FixedPoint64<4>, long long, unsigned long long, 0x152a800000000000ll, 11u>(bitstream, nmin, nmax, pmax, emin) {}
};
