...
public:
  Codec2f(BitStream& bitstream, uint nmin = 0, uint nmax = 0, uint pmax = 0, int emin = INT_MIN) : Codec2<BitStream, float, FixedPoint::FixedPoint32<3>, int, unsigned int, 0x2a550000, 8u>(bitstream, nmin, nmax, pmax, emin) {}
};
