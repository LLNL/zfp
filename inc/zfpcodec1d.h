...
public:
  Codec1d(BitStream& bitstream, uint nmin = 0, uint nmax = 0, uint pmax = 0, int emin = INT_MIN) : Codec1<BitStream, double, FixedPoint::FixedPoint64<2>, long long, unsigned long long, 0x54aa000000000000ll, 11u>(bitstream, nmin, nmax, pmax, emin) {}
};
