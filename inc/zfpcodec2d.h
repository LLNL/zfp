...
public:
  Codec2d(BitStream& bitstream, uint nmin = 0, uint nmax = 0, uint pmax = 0, int emin = INT_MIN) : Codec2<BitStream, double, FixedPoint::FixedPoint64<3>, long long, unsigned long long, 0x2a55000000000000ll, 11u>(bitstream, nmin, nmax, pmax, emin) {}
};
