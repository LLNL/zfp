...
int main()
{
  const struct CMUnitTest tests[] = {
    ...
    cmocka_unit_test_setup_teardown(given_cfp_ptr3d_when_get_offset_ref_expect_correct, setupCfpArrSmall, teardownCfpArr),
    cmocka_unit_test_setup_teardown(given_cfp_ptr3d_when_compare_expect_correct, setupCfpArrSmall, teardownCfpArr),
    cmocka_unit_test_setup_teardown(given_cfp_ptr3d_when_diff_expect_correct, setupCfpArrSmall, teardownCfpArr),
