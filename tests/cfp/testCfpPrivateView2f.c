...
int main()
{
  const struct CMUnitTest tests[] = {
    ...
    cmocka_unit_test(given_cfp_private_view2f_when_partitionWithLimitOnCount_then_setsUniqueBlockBoundsAlongLongerDimension),
    ...
    cmocka_unit_test_setup_teardown(given_cfp_private_view2f_when_set_expect_getValueMatches, setupCfpViewSmall, teardownCfpView),
