...
int main()
{
  const struct CMUnitTest tests[] = {
    ...
    cmocka_unit_test_setup_teardown(given_1dInt32ReversedArray_when_ZfpCompressFixedPrecision_expect_BitstreamChecksumMatches, setupReversed, teardown),
    cmocka_unit_test_setup_teardown(given_1dInt32ReversedArray_when_ZfpDecompressFixedPrecision_expect_ArrayChecksumMatches, setupReversed, teardown),
    cmocka_unit_test_setup_teardown(given_1dInt32InterleavedArray_when_ZfpCompressFixedPrecision_expect_BitstreamChecksumMatches, setupInterleaved, teardown),
    cmocka_unit_test_setup_teardown(given_1dInt32InterleavedArray_when_ZfpDecompressFixedPrecision_expect_ArrayChecksumMatches, setupInterleaved, teardown),
