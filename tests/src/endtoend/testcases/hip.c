...
#ifdef FL_PT_DATA
_cmocka_unit_test_setup_teardown(_catFunc3(given_Hip_, DIM_INT_STR, ReversedArray_when_ZfpCompressDecompressFixedAccuracy_expect_BitstreamAndArrayChecksumsMatch), setupReversedIndexed, teardown),
#endif
...
_cmocka_unit_test_setup_teardown(_catFunc3(given_Hip_, DIM_INT_STR, PermutedArray_when_ZfpCompressDecompressFixedPrecision_expect_BitstreamAndArrayChecksumsMatch), setupPermutedIndexed, teardown),
#ifdef FL_PT_DATA
_cmocka_unit_test_setup_teardown(_catFunc3(given_Hip_, DIM_INT_STR, PermutedArray_when_ZfpCompressDecompressFixedAccuracy_expect_BitstreamAndArrayChecksumsMatch), setupPermutedIndexed, teardown),
#endif
#endif

/* HIP expects contiguous storage */
...
_cmocka_unit_test_setup_teardown(_catFunc3(given_Hip_, DIM_INT_STR, InterleavedArray_when_ZfpCompressDecompressFixedPrecision_expect_BitstreamUntouchedAndReturnsZero), setupInterleaved, teardown),
#ifdef FL_PT_DATA
_cmocka_unit_test_setup_teardown(_catFunc3(given_Hip_, DIM_INT_STR, InterleavedArray_when_ZfpCompressDecompressFixedAccuracy_expect_BitstreamUntouchedAndReturnsZero), setupInterleaved, teardown),
#endif
