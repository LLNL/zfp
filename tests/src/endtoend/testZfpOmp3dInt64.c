...
int main()
{
  const struct CMUnitTest tests[] = {
    ...
    /* strided tests */
    cmocka_unit_test_setup_teardown(given_OpenMP_3dInt64ReversedArray_when_ZfpCompressFixedPrecision_expect_BitstreamChecksumMatches, setupReversed0Thread0Chunk, teardown),
    cmocka_unit_test_setup_teardown(given_OpenMP_3dInt64ReversedArray_when_ZfpCompressFixedPrecision_expect_BitstreamChecksumMatches, setupReversed0Thread1Chunk, teardown),
    cmocka_unit_test_setup_teardown(given_OpenMP_3dInt64ReversedArray_when_ZfpCompressFixedPrecision_expect_BitstreamChecksumMatches, setupReversed0Thread2Chunk, teardown),
    cmocka_unit_test_setup_teardown(given_OpenMP_3dInt64ReversedArray_when_ZfpCompressFixedPrecision_expect_BitstreamChecksumMatches, setupReversed1Thread0Chunk, teardown),
    cmocka_unit_test_setup_teardown(given_OpenMP_3dInt64ReversedArray_when_ZfpCompressFixedPrecision_expect_BitstreamChecksumMatches, setupReversed1Thread1Chunk, teardown),
    cmocka_unit_test_setup_teardown(given_OpenMP_3dInt64ReversedArray_when_ZfpCompressFixedPrecision_expect_BitstreamChecksumMatches, setupReversed1Thread2Chunk, teardown),
    cmocka_unit_test_setup_teardown(given_OpenMP_3dInt64ReversedArray_when_ZfpCompressFixedPrecision_expect_BitstreamChecksumMatches, setupReversed2Thread0Chunk, teardown),
    cmocka_unit_test_setup_teardown(given_OpenMP_3dInt64ReversedArray_when_ZfpCompressFixedPrecision_expect_BitstreamChecksumMatches, setupReversed2Thread1Chunk, teardown),
    cmocka_unit_test_setup_teardown(given_OpenMP_3dInt64ReversedArray_when_ZfpCompressFixedPrecision_expect_BitstreamChecksumMatches, setupReversed2Thread2Chunk, teardown),
