...
int main()
{
  const struct CMUnitTest tests[] = {
    ...
    /* strided tests */
    cmocka_unit_test_setup_teardown(given_OpenMP_3dInt64PermutedArray_when_ZfpCompressFixedPrecision_expect_BitstreamChecksumMatches, setupPermuted0Thread0Chunk, teardown),
    cmocka_unit_test_setup_teardown(given_OpenMP_3dInt64PermutedArray_when_ZfpDecompressFixedPrecision_expect_ArrayChecksumMatches, setupPermuted0Thread0Chunk, teardown),
    cmocka_unit_test_setup_teardown(given_OpenMP_3dInt64PermutedArray_when_ZfpCompressFixedPrecision_expect_BitstreamChecksumMatches, setupPermuted0Thread1Chunk, teardown),
    cmocka_unit_test_setup_teardown(given_OpenMP_3dInt64PermutedArray_when_ZfpDecompressFixedPrecision_expect_ArrayChecksumMatches, setupPermuted0Thread1Chunk, teardown),
    cmocka_unit_test_setup_teardown(given_OpenMP_3dInt64PermutedArray_when_ZfpCompressFixedPrecision_expect_BitstreamChecksumMatches, setupPermuted0Thread2Chunk, teardown),
    cmocka_unit_test_setup_teardown(given_OpenMP_3dInt64PermutedArray_when_ZfpDecompressFixedPrecision_expect_ArrayChecksumMatches, setupPermuted0Thread2Chunk, teardown),
    cmocka_unit_test_setup_teardown(given_OpenMP_3dInt64PermutedArray_when_ZfpCompressFixedPrecision_expect_BitstreamChecksumMatches, setupPermuted1Thread0Chunk, teardown),
    cmocka_unit_test_setup_teardown(given_OpenMP_3dInt64PermutedArray_when_ZfpDecompressFixedPrecision_expect_ArrayChecksumMatches, setupPermuted1Thread0Chunk, teardown),
    cmocka_unit_test_setup_teardown(given_OpenMP_3dInt64PermutedArray_when_ZfpCompressFixedPrecision_expect_BitstreamChecksumMatches, setupPermuted1Thread1Chunk, teardown),
    cmocka_unit_test_setup_teardown(given_OpenMP_3dInt64PermutedArray_when_ZfpDecompressFixedPrecision_expect_ArrayChecksumMatches, setupPermuted1Thread1Chunk, teardown),
    cmocka_unit_test_setup_teardown(given_OpenMP_3dInt64PermutedArray_when_ZfpCompressFixedPrecision_expect_BitstreamChecksumMatches, setupPermuted1Thread2Chunk, teardown),
    cmocka_unit_test_setup_teardown(given_OpenMP_3dInt64PermutedArray_when_ZfpDecompressFixedPrecision_expect_ArrayChecksumMatches, setupPermuted1Thread2Chunk, teardown),
    cmocka_unit_test_setup_teardown(given_OpenMP_3dInt64PermutedArray_when_ZfpCompressFixedPrecision_expect_BitstreamChecksumMatches, setupPermuted2Thread0Chunk, teardown),
    cmocka_unit_test_setup_teardown(given_OpenMP_3dInt64PermutedArray_when_ZfpDecompressFixedPrecision_expect_ArrayChecksumMatches, setupPermuted2Thread0Chunk, teardown),
    cmocka_unit_test_setup_teardown(given_OpenMP_3dInt64PermutedArray_when_ZfpCompressFixedPrecision_expect_BitstreamChecksumMatches, setupPermuted2Thread1Chunk, teardown),
    cmocka_unit_test_setup_teardown(given_OpenMP_3dInt64PermutedArray_when_ZfpDecompressFixedPrecision_expect_ArrayChecksumMatches, setupPermuted2Thread1Chunk, teardown),
    cmocka_unit_test_setup_teardown(given_OpenMP_3dInt64PermutedArray_when_ZfpCompressFixedPrecision_expect_BitstreamChecksumMatches, setupPermuted2Thread2Chunk, teardown),
    cmocka_unit_test_setup_teardown(given_OpenMP_3dInt64PermutedArray_when_ZfpDecompressFixedPrecision_expect_ArrayChecksumMatches, setupPermuted2Thread2Chunk, teardown),

    cmocka_unit_test_setup_teardown(given_OpenMP_3dInt64InterleavedArray_when_ZfpCompressFixedPrecision_expect_BitstreamChecksumMatches, setupInterleaved0Thread0Chunk, teardown),
    cmocka_unit_test_setup_teardown(given_OpenMP_3dInt64InterleavedArray_when_ZfpDecompressFixedPrecision_expect_ArrayChecksumMatches, setupInterleaved0Thread0Chunk, teardown),
    cmocka_unit_test_setup_teardown(given_OpenMP_3dInt64InterleavedArray_when_ZfpCompressFixedPrecision_expect_BitstreamChecksumMatches, setupInterleaved0Thread1Chunk, teardown),
    cmocka_unit_test_setup_teardown(given_OpenMP_3dInt64InterleavedArray_when_ZfpDecompressFixedPrecision_expect_ArrayChecksumMatches, setupInterleaved0Thread1Chunk, teardown),
    cmocka_unit_test_setup_teardown(given_OpenMP_3dInt64InterleavedArray_when_ZfpCompressFixedPrecision_expect_BitstreamChecksumMatches, setupInterleaved0Thread2Chunk, teardown),
    cmocka_unit_test_setup_teardown(given_OpenMP_3dInt64InterleavedArray_when_ZfpDecompressFixedPrecision_expect_ArrayChecksumMatches, setupInterleaved0Thread2Chunk, teardown),
    cmocka_unit_test_setup_teardown(given_OpenMP_3dInt64InterleavedArray_when_ZfpCompressFixedPrecision_expect_BitstreamChecksumMatches, setupInterleaved1Thread0Chunk, teardown),
    cmocka_unit_test_setup_teardown(given_OpenMP_3dInt64InterleavedArray_when_ZfpDecompressFixedPrecision_expect_ArrayChecksumMatches, setupInterleaved1Thread0Chunk, teardown),
    cmocka_unit_test_setup_teardown(given_OpenMP_3dInt64InterleavedArray_when_ZfpCompressFixedPrecision_expect_BitstreamChecksumMatches, setupInterleaved1Thread1Chunk, teardown),
    cmocka_unit_test_setup_teardown(given_OpenMP_3dInt64InterleavedArray_when_ZfpDecompressFixedPrecision_expect_ArrayChecksumMatches, setupInterleaved1Thread1Chunk, teardown),
    cmocka_unit_test_setup_teardown(given_OpenMP_3dInt64InterleavedArray_when_ZfpCompressFixedPrecision_expect_BitstreamChecksumMatches, setupInterleaved1Thread2Chunk, teardown),
    cmocka_unit_test_setup_teardown(given_OpenMP_3dInt64InterleavedArray_when_ZfpDecompressFixedPrecision_expect_ArrayChecksumMatches, setupInterleaved1Thread2Chunk, teardown),
    cmocka_unit_test_setup_teardown(given_OpenMP_3dInt64InterleavedArray_when_ZfpCompressFixedPrecision_expect_BitstreamChecksumMatches, setupInterleaved2Thread0Chunk, teardown),
    cmocka_unit_test_setup_teardown(given_OpenMP_3dInt64InterleavedArray_when_ZfpDecompressFixedPrecision_expect_ArrayChecksumMatches, setupInterleaved2Thread0Chunk, teardown),
    cmocka_unit_test_setup_teardown(given_OpenMP_3dInt64InterleavedArray_when_ZfpCompressFixedPrecision_expect_BitstreamChecksumMatches, setupInterleaved2Thread1Chunk, teardown),
    cmocka_unit_test_setup_teardown(given_OpenMP_3dInt64InterleavedArray_when_ZfpDecompressFixedPrecision_expect_ArrayChecksumMatches, setupInterleaved2Thread1Chunk, teardown),
    cmocka_unit_test_setup_teardown(given_OpenMP_3dInt64InterleavedArray_when_ZfpCompressFixedPrecision_expect_BitstreamChecksumMatches, setupInterleaved2Thread2Chunk, teardown),
    cmocka_unit_test_setup_teardown(given_OpenMP_3dInt64InterleavedArray_when_ZfpDecompressFixedPrecision_expect_ArrayChecksumMatches, setupInterleaved2Thread2Chunk, teardown),
