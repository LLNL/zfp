...
typedef struct {
  ...
  void (*set)(const cfp_view3f self, size_t i, size_t j, size_t k, float val);
  ...
  cfp_ptr_view3f (*ptr)(cfp_view3f self, size_t i, size_t j, size_t k);
...
typedef struct {
  ...
  void (*set)(const cfp_flat_view3f self, size_t i, size_t j, size_t k, float val);
  ...
  cfp_ptr_flat_view3f (*ptr)(cfp_flat_view3f self, size_t i, size_t j, size_t k);
...
typedef struct {
  ...
  void (*set)(const cfp_private_view3f self, size_t i, size_t j, size_t k, float val);
  ...
  cfp_ptr_private_view3f (*ptr)(cfp_private_view3f self, size_t i, size_t j, size_t k);
