...
{
   return src.reference.i - self.reference.i;
}
...
{
  return self.array.object == src.array.object && self.i < src.i;
}
...
{
  return _t1(CFP_ARRAY_TYPE, ref)(self.array, self.i);
}
...
{
  return _t1(CFP_ARRAY_TYPE, ptr)(self.array, self.i);
}
