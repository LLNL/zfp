...
{
  return static_cast<const ZFP_ARRAY_TYPE*>(self.reference.container)->operator()(self.reference.x, self.reference.y, self.reference.z);
}
...
{
  static_cast<ZFP_ARRAY_TYPE*>(self.reference.container)->operator()(self.reference.x, self.reference.y, self.reference.z) = val;
}
