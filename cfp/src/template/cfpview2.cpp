...
_t1(CFP_CONTAINER_TYPE, ctor_subset)(const CFP_ARRAY_TYPE a, size_t x, size_t y, size_t nx, size_t ny)
{
  CFP_CONTAINER_TYPE v;
  v.object = new ZFP_CONTAINER_TYPE(static_cast<ZFP_ARRAY_TYPE *>(a.object), x, y, nx, ny);
  return v;
}
