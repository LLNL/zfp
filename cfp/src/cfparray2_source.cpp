...
{
  size_t selfIdx = (int)(self.reference.i + self.reference.j*reinterpret_cast<const ZFP_ARRAY_TYPE*>(self.reference.array.object)->size_x());
  size_t srcIdx = (int)(src.reference.i + src.reference.j*reinterpret_cast<const ZFP_ARRAY_TYPE*>(src.reference.array.object)->size_x());
...
{
  size_t idx = (int)(self.reference.i + self.reference.j*reinterpret_cast<const ZFP_ARRAY_TYPE*>(self.reference.array.object)->size_x()) + d;
...
{
  return reinterpret_cast<const ZFP_ARRAY_TYPE*>(self.reference.array.object)->operator()(self.reference.i, self.reference.j);
}
...
{
  reinterpret_cast<ZFP_ARRAY_TYPE*>(self.reference.array.object)->operator()(self.reference.i, self.reference.j) = val;
}
...
{
  size_t idx = (int)(self.reference.i + self.reference.j*reinterpret_cast<const ZFP_ARRAY_TYPE*>(self.reference.array.object)->size_x()) + 1;
...
{
  return reinterpret_cast<ZFP_ARRAY_TYPE*>(self.array.object)->operator()(self.i, self.j);
}
...
_t2(CFP_ARRAY_TYPE, CFP_ITER_TYPE, inc)(CFP_ITER_TYPE self)
{
  ...
  size_t nx = reinterpret_cast<const ZFP_ARRAY_TYPE*>(self.array.object)->size_x();
  size_t ny = reinterpret_cast<const ZFP_ARRAY_TYPE*>(self.array.object)->size_y();
...
{
  size_t idx = (int)(self.i + self.j*reinterpret_cast<const ZFP_ARRAY_TYPE*>(self.array.object)->size_x()) + d;

  self.i = idx % reinterpret_cast<const ZFP_ARRAY_TYPE*>(self.array.object)->size_x();
  self.j = idx / reinterpret_cast<const ZFP_ARRAY_TYPE*>(self.array.object)->size_x();
